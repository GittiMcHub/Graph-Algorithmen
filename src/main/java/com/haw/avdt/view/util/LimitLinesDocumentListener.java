package com.haw.avdt.view.util;
 ...
 *
 * a) if you append text to the Document, then you would want to remove lines from the start. b) if you insert
...
public class LimitLinesDocumentListener implements DocumentListener {
    ...
    /*
     * Specify the number of lines to be stored in the Document. Extra lines will be removed from the start of
     * the Document.
     */
    ...
    /*
     * Specify the number of lines to be stored in the Document. Extra lines will be removed from the start or
     * end of the Document, depending on the boolean value specified.
     */
